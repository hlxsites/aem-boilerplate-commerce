...
describe("Verify user can manage products across cart and wishlist", { tags: "@skipSaas" }, () => {
  it("Should successfully add simple product to wishlist, move to cart and return to wishlist", () => {
    cy.visit("");
