...
//       cy.get('input[name="first_name"]', { timeout: 5000 }).should(
//         "be.visible",
//       );
...
//       cy.logToTerminal(
//         "--- STEP 3: TC-17 - Add new user with unregistered email ---",
//       );
...
//       cy.get('select[name="role"]:visible', { timeout: 5000 })
//         .should("be.visible")
//         .select("Default User");
...
//       cy.logToTerminal(
//         "--- STEP 4: TC-21 - Test duplicate email validation ---",
//       );
...
//         cy.logToTerminal(
//           `📝 Attempting to add duplicate email: ${existingEmail}...`,
//         );
...
//         cy.logToTerminal(
//           "✅ TC-21: Duplicate email validation works correctly",
//         );
...
//       cy.get(".company-management-company-users-management-modal", {
//         timeout: 5000,
//       }).should("be.visible");
...
//         () => {
//           cy.get("button")
//             .contains("Set as Inactive", { timeout: 5000 })
//             .should("be.visible")
//             .click();
//         },
//       );
...
//       // Verify success message
//       cy.contains(/deactivated|inactive/i, { timeout: 5000 }).should(
//         "be.visible",
//       );
...
//         cy.logToTerminal(
//           `✅ Standalone customer created: ${standaloneUser.email} (ID: ${standaloneUser.id})`,
//         );
...
//       cy.logToTerminal(
//         "📝 Filling in invitation form with registered email...",
//       );
//       cy.then(() => {
...
//         cy.logToTerminal(
//           "🔗 Accepting invitation via REST API (WORKAROUND)...",
//         );
...
//         cy.logToTerminal(
//           `🔄 Setting user ${standaloneUserId} to inactive via REST API...`,
//         );
...
//         cy.logToTerminal(
//           `🔄 Setting user ${standaloneUserId} to active via REST API...`,
//         );
...
//       cy.logToTerminal(
//         "✅ TC-19: Inactive user activation flow completed successfully",
//       );
...
//       cy.logToTerminal(
//         "✅ Verifying role is disabled (admin cannot change own role)...",
//       );
...
//       cy.get('input[name="telephone"]').clear().type("555-9999").blur();
...
//           .find("button.manage-user-button")
//           .first()
//           .should("be.visible")
//           .click();
//       });
...
//       cy.logToTerminal(
//         "✅ TC-20: Admin protected from self-deletion (buttons exist but action is restricted)",
//       );
