...
describe.skip(
  "Verify B2B Requisition Lists feature",
  { tags: "@B2BSaas" },
  () => {
    ...
    it("Verify B2B Requisition is available for authenticated users", () => {
      ...
      describe.skip("Configurable Product Option Validation", () => {
        ...
        cy.get(".product-details__buttons")
          .find(fields.requisitionListSelector)
          .click();
        cy.get(fields.productDetailsAlert)
          .should("be.visible")
          .contains(
      ...
      describe.skip("Bundle Product Option Validation", () => {
        // Ignore the expected redirect error
        cy.on("uncaught:exception", (err) => {
          if (err.message.includes("Redirecting to product page")) {
            return false;
      ...
      describe.skip("Requisition List Grid Workflow", () => {
      ...
      describe.skip("Requisition List View Workflow", () => {
        ...
        cy.get(
          ".requisition-list__alert-wrapper .dropin-in-line-alert__title",
          {
            timeout: 30000,
          },
        )
