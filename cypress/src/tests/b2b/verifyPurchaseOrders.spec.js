...
describe('B2B Purchase Orders', { retries: 0 }, () => {
  ...
  it(
    ...
    () => {
      ...
      cy.contains(poLabels.approvalRulesHeader, { timeout: 15000 }).should('be.visible');
      ...
      cy.visit('/');
      cy.get(selectors.poNavDropdownButton, { timeout: 10000 }).should('be.visible');
  ...
  it(
    ...
    () => {
      ...
      const MAX_APPROVAL_FETCH_ATTEMPTS = 5;
      const APPROVAL_RETRY_DELAY = 5000;
      ...
      cy.reload();
      cy.get(selectors.poApprovalPOWrapper, { timeout: 15000 }).should('be.visible');
      cy.contains('Requires my approval', { timeout: 10000 }).should('be.visible');
  ...
  it(
    ...
    () => {
      ...
      cy.contains('Requires my approval', { timeout: 15000 }).should('be.visible');
      ...
      cy.get('.dropin-header-container__title', { timeout: 15000 }).should('have.length.gt', 7);
  ...
  it(
    ...
    () => {
      ...
      cy.get(selectors.poCompanyPOContainer, { timeout: 15000 }).should('exist');
      cy.contains('Company purchase orders', { timeout: 10000 }).should('be.visible');
