...
import { j as setPersistedWishlistData, s as state, f as fetchGraphQl, h as handleFetchError, g as getPersistedWishlistData, i as isMatchingWishlistItem, k as clearPersistedLocalStorage } from "./removeProductsFromWishlist.js";
const initialize = new Initializer({
  ...
  listeners: () => [events.on("wishlist/data", (payload) => {
