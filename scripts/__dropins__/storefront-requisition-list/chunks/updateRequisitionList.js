...
`;function b(t){var e,o;return t?{uid:t.uid,name:t.name,description:t.description,updated_at:t.updated_at,items_count:t.items_count,items:T((e=t.items)==null?void 0:e.items),page_info:(o=t.items)==null?void 0:o.page_info}:null}function T(t){return t!=null&&t.length?t.map(e=>{var a,_,n,u;const o={uid:e.uid,sku:(a=e.product)==null?void 0:a.sku,quantity:e.quantity,stock_status:((_=e.product)==null?void 0:_.stock_status)||"IN_STOCK",only_x_left_in_stock:((n=e.product)==null?void 0:n.only_x_left_in_stock)??null,customizable_options:e.customizable_options?e.customizable_options.map(i=>({uid:i.customizable_option_uid,is_required:i.is_required,label:i.label,sort_order:i.sort_order,type:i.type,values:i.values.map(r=>({uid:r.customizable_option_value_uid,label:r.label,price:r.price,value:r.value}))})):[],bundle_options:e.bundle_options||[],configurable_options:e.configurable_options?e.configurable_options.map(i=>({option_uid:i.configurable_product_option_uid,option_label:i.option_label,value_uid:i.configurable_product_option_value_uid,value_label:i.value_label})):[],samples:e.samples?e.samples.map(i=>({url:i.sample_url,sort_order:i.sort_order,title:i.title})):[],gift_card_options:e.gift_card_options||{}};return(u=e.configured_product)!=null&&u.name?{...o,configured_product:e.configured_product}:o}):[]}const R=`
...
${g}
${f}
`,y=async(t,e,o,a,_,n)=>{var l,c;const{errors:u,data:i}=await m(R,{variables:{requisitionListUid:t,name:e,description:o,pageSize:a,currentPage:_}});if(u)return I(u);if(!((l=i==null?void 0:i.updateRequisitionList)!=null&&l.requisition_list))return null;const r=i.updateRequisitionList.requisition_list;let s=b(r);return(c=s==null?void 0:s.items)!=null&&c.length&&n&&(s={...s,items:await n(s.items)}),p.emit("requisitionList/data",s),s};export{g as R,f as a,E as b,N as c,m as f,h as g,I as h,v as r,S as s,b as t,y as u};
