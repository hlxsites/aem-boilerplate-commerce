...
All Rights Reserved. */
import { Icon, Picker } from "@dropins/tools/components.js";
import { classes } from "@dropins/tools/lib.js";
import "./PageSizePicker2.js";
...
var _jsxFileName$1 = "/Users/rafaljanicki/www/storefront-requisition-list/src/components/EmptyList/EmptyList.tsx";
const EmptyList = ({
  className,
  textContent,
  ...props
...
var _jsxFileName = "/Users/rafaljanicki/www/storefront-requisition-list/src/components/PageSizePicker/PageSizePicker.tsx";
const PageSizePicker = ({
  ...
  return u("div", {
    ...
    children: [u("label", {
      ...
      className: "page-size-picker__label",
      children: [translations.itemsPerPage, ":"]
    }, void 0, true, {
      ...
      disabled,
      className: "page-size-picker__select",
      "data-testid": "page-size-picker-select",
      options,
      placeholder: "",
      variant: "secondary",
      size: "small"
