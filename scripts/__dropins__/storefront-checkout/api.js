...
`,rn=`
  ...
  ${T}
`,P=()=>{const{cartId:e,quoteId:t}=s;if(!e&&!t)throw new Nt},Y=(e,t,n,r,i,o)=>async a=>await m({type:"mutation",query:n,options:{variables:{[t]:e,billingAddress:i(a)}},path:o,queueName:E.Updates,transformer:r}),sn=({address:e,companyAddressId:t,customerAddressId:n,customerAddressUid:r,sameAsShipping:i=!1})=>{if(!t){if(!n&&r)throw new I("customerAddressUid is not supported");if(!i&&!n&&!e)throw new Ie}},on=({address:e,customerAddressId:t,customerAddressUid:n,sameAsShipping:r=!1})=>{if(!n&&t)throw new I("customerAddressId is not supported");if(!r&&!n&&!e)throw new Ie},an=e=>{const t=!!s.cartId,n=!!s.quoteId;t?sn(e):n&&on(e)},Yn=async e=>(P(),an(e),await(!!s.cartId?Y(s.cartId,"cartId",nn,N,je,"setBillingAddressOnCart.cart"):Y(s.quoteId,"quoteId",rn,w,Ve,"setNegotiableQuoteBillingAddress.quote"))(e)),un=`
