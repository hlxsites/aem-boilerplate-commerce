declare const _default: {
  "Auth": {
    ...
    "SignUpForm": {
      ...
      "loginAsCustomerConsentLabel": "Allow remote shopping assistance",
      "loginAsCustomerConsentTooltip": "This allows merchants to \"see what you see\" and take actions on your behalf in order to provide better assistance.",
      "confirmPassword": {
