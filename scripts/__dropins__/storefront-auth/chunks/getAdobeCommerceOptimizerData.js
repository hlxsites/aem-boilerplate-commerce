...
`,K=async(e="Authorization",t="Bearer")=>{const r=M(c.auth_dropin_user_token);return r?(G(e,`${t} ${r}`),C($).then(async o=>{var i,n,_,m;return!((i=o.errors)!=null&&i.find(l=>{var d;return((d=l.extensions)==null?void 0:d.category)==="graphql-authentication"}))?(await E((m=(_=(n=o.data)==null?void 0:n.customer)==null?void 0:_.group)==null?void 0:m.uid),s.emit("authenticated",!0),!0):(f(c.auth_dropin_user_token),f(c.auth_dropin_firstname),f(c.auth_dropin_lastname),f(c.auth_dropin_admin_session),U(e),await E(),s.emit("authenticated",!1),!1)})):(await E(),s.emit("authenticated",!1),!1)},J=`
...
`,w=async()=>{const e=await C(ee,{method:"GET"}),t=N(e);return s.emit("auth/adobe-commerce-optimizer",t),t};export{c as C,ie as L,ce as _,R as a,w as b,se as c,f as d,E as e,ne as f,F as g,D as h,O as i,K as v};
