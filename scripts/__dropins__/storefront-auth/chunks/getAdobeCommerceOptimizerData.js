...
`,x=async()=>await l(G,{method:"GET",cache:"force-cache"}).then(e=>{var t;return(t=e.errors)!=null&&t.length?w(e.errors):M(e)}).catch(y),U=`
...
`,z=async(e="Authorization",t="Bearer")=>{const r=P(E.auth_dropin_user_token);return r?(I(e,`${t} ${r}`),l(U).then(async o=>{var n,s,u,m;return!((n=o.errors)!=null&&n.find(h=>{var d;return((d=h.extensions)==null?void 0:d.category)==="graphql-authentication"}))?(await C((m=(u=(s=o.data)==null?void 0:s.customer)==null?void 0:u.group)==null?void 0:m.uid),i.emit("authenticated",!0),!0):(R(E.auth_dropin_user_token),k(e),await C(),i.emit("authenticated",!1),!1)})):(await C(),i.emit("authenticated",!1),!1)},D=`
