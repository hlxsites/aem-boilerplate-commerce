...
`;let r=null,s=null;const C=e=>{const i={},t=n=>{n.forEach(o=>{var f;i[o.id]=!0,(f=o.children)!=null&&f.length&&t(o.children)})};return t(e),i},P=e=>(e==null?void 0:e.id)==="MA=="&&Array.isArray(e.permissions)&&e.permissions.length===0,E=e=>{var t;if(P(e))return{admin:!0};const i={all:!0};if((t=e==null?void 0:e.permissions)!=null&&t.length){const n=C(e.permissions);return{...i,...n}}return i},_=async()=>{var e,i;try{const t=await g(p,{method:"GET"}),n=E((i=(e=t.data)==null?void 0:e.customer)==null?void 0:i.role);return r=n,s=null,n}catch(t){throw s=null,t}},d=()=>r?(c.emit("auth/permissions",r),Promise.resolve(r)):(s||(s=_().then(e=>(c.emit("auth/permissions",e),e))),s),w=()=>{r=null,s=null};export{w as _,T as c,d as g,m as i};
