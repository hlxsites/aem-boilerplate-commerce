...
All Rights Reserved. */
import{CUSTOMER_INFORMATION_FRAGMENT as O}from"../fragments.js";import{c as b,f as s,h as u}from"./setReCaptchaToken.js";import"@dropins/tools/event-bus.js";import"@dropins/tools/recaptcha.js";import{merge as N}from"@dropins/tools/lib.js";import{c as F,k as S}from"./getAdobeCommerceOptimizerData.js";import{t as p}from"./transform-attributes-form.js";const I=`
...
`,x=async r=>await s(v,{method:"GET",cache:"force-cache",variables:{formCode:r}}).then(e=>{var o;return(o=e.errors)!=null&&o.length?S(e.errors):p(e)}).catch(u),y=`
  mutation CREATE_CUSTOMER_ADDRESS($input: CustomerAddressInput!) {
    createCustomerAddress(input: $input) {
      firstname
    }
  }
`,Q=async r=>await s(y,{method:"POST",variables:{input:r}}).then(e=>{var o;return(o=e.errors)!=null&&o.length?S(e.errors):e.data.createCustomerAddress.firstname||""}).catch(u);export{Q as a,P as c,x as g};
