...
All Rights Reserved. */
import{f as O,h as R}from"./fetch-graphql.js";import{h as E}from"./fetch-error.js";import{P as y,t as v}from"./rejectPurchaseOrders.js";const q=`
...
`,N=async c=>{var e;if(!c||c.trim()==="")throw new Error("Purchase Order UID is required");const u={purchase_order_uid:c};try{const n=await O(F,{variables:{input:u}});return(e=n.errors)!=null&&e.length&&E(n.errors),w(n)}catch(n){throw R(n)}};export{G as c,N as p};
