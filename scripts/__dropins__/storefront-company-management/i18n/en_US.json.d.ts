  ...
  "Company": {
    ...
    "CompanyProfile": {
      ...
      "editCompanyProfile": {
        ...
        "addressBook": {
          "sectionTitle": "Address Book Configuration",
          "addressBookEnabled": "Enable Company Address Book",
          "customAddressEnabled": "Allow Custom Company Address"
        }
      },
      "companyProfileCard": {
        ...
        "addressBookConfiguration": "Address Book Configuration",
        "addressBookEnabled": "Enable Company Address Book",
        "customShippingAddressEnabled": "Allow Custom Company Address",
      ...
      "messages": {
        ...
        "configUpdateError": "Failed to update company address book configuration"
      }
    },
    "CompanyStructure": {
