...
All Rights Reserved. */
import{t as a}from"./validateCompanyEmail.js";import{f as d,c as l,h as g}from"./fetch-error.js";const u=`
...
`,_="US",s={defaultCountry:_,storeCode:""},T=async()=>await d(m,{method:"GET"}).then(e=>{var r;return(r=e.errors)!=null&&r.length?l(e.errors):y(e)}).catch(g),y=e=>{var t;if(!((t=e==null?void 0:e.data)!=null&&t.storeConfig))return s;const{default_country:r,store_code:o}=e.data.storeConfig;return{defaultCountry:r||s.defaultCountry,storeCode:o||s.storeCode}};export{_ as D,s as S,I as c,T as g};
