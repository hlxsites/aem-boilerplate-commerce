...
`,p=async()=>{var t;try{if(!(await h()).companyEnabled)return null;const n=await l(d,{method:"GET",cache:"no-cache"});return(t=n.errors)!=null&&t.length?m(n.errors):u(n)}catch(a){return y(a)}};export{h as c,p as g};
