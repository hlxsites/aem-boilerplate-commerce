...
`,Ae="US",O={defaultCountry:Ae,storeCode:""},bt=async()=>await d(Ee,{method:"GET"}).then(e=>{var t;return(t=e.errors)!=null&&t.length?_(e.errors):Te(e)}).catch(m),Te=e=>{var n;if(!((n=e==null?void 0:e.data)!=null&&n.storeConfig))return O;const{default_country:t,store_code:a}=e.data.storeConfig;return{defaultCountry:t||O.defaultCountry,storeCode:a||O.storeCode}},Ie=e=>{var t,a,n,r,i,s,c,o,u,l,p,y,g,C,h,f,E,A,T,I,M,b,N,R;return{credit:{available_credit:{currency:((r=(n=(a=(t=e==null?void 0:e.data)==null?void 0:t.company)==null?void 0:a.credit)==null?void 0:n.available_credit)==null?void 0:r.currency)||"",value:((o=(c=(s=(i=e==null?void 0:e.data)==null?void 0:i.company)==null?void 0:s.credit)==null?void 0:c.available_credit)==null?void 0:o.value)||0},credit_limit:{currency:((y=(p=(l=(u=e==null?void 0:e.data)==null?void 0:u.company)==null?void 0:l.credit)==null?void 0:p.credit_limit)==null?void 0:y.currency)||"",value:((f=(h=(C=(g=e==null?void 0:e.data)==null?void 0:g.company)==null?void 0:C.credit)==null?void 0:h.credit_limit)==null?void 0:f.value)||0},outstanding_balance:{currency:((I=(T=(A=(E=e==null?void 0:e.data)==null?void 0:E.company)==null?void 0:A.credit)==null?void 0:T.outstanding_balance)==null?void 0:I.currency)||"",value:((R=(N=(b=(M=e==null?void 0:e.data)==null?void 0:M.company)==null?void 0:b.credit)==null?void 0:N.outstanding_balance)==null?void 0:R.value)||0}}}},Me=e=>{var a,n,r,i,s,c;const t=(n=(a=e==null?void 0:e.data)==null?void 0:a.company)==null?void 0:n.credit_history;return{items:((r=t==null?void 0:t.items)==null?void 0:r.map(o=>{var u,l,p,y,g,C,h,f,E,A,T,I,M,b,N,R;return{amount:{currency:((u=o==null?void 0:o.amount)==null?void 0:u.currency)||"",value:((l=o==null?void 0:o.amount)==null?void 0:l.value)||0},balance:{availableCredit:{currency:((y=(p=o==null?void 0:o.balance)==null?void 0:p.available_credit)==null?void 0:y.currency)||"",value:((C=(g=o==null?void 0:o.balance)==null?void 0:g.available_credit)==null?void 0:C.value)||0},creditLimit:{currency:((f=(h=o==null?void 0:o.balance)==null?void 0:h.credit_limit)==null?void 0:f.currency)||"",value:((A=(E=o==null?void 0:o.balance)==null?void 0:E.credit_limit)==null?void 0:A.value)||0},outstandingBalance:{currency:((I=(T=o==null?void 0:o.balance)==null?void 0:T.outstanding_balance)==null?void 0:I.currency)||"",value:((b=(M=o==null?void 0:o.balance)==null?void 0:M.outstanding_balance)==null?void 0:b.value)||0}},customReferenceNumber:(o==null?void 0:o.custom_reference_number)||void 0,date:(o==null?void 0:o.date)||"",type:(o==null?void 0:o.type)||"",updatedBy:{name:((N=o==null?void 0:o.updated_by)==null?void 0:N.name)||"",type:((R=o==null?void 0:o.updated_by)==null?void 0:R.type)||""}}}))||[],pageInfo:{currentPage:((i=t==null?void 0:t.page_info)==null?void 0:i.current_page)||1,pageSize:((s=t==null?void 0:t.page_info)==null?void 0:s.page_size)||20,totalPages:((c=t==null?void 0:t.page_info)==null?void 0:c.total_pages)||0},totalCount:(t==null?void 0:t.total_count)||0}},be=`
...
`;async function Ne(){var e;try{if(!await ne())return null;const a=await d(be,{method:"GET",cache:"no-cache"});return(e=a.errors)!=null&&e.length?_(a.errors):fe(a)}catch(t){return m(t)}}async function Nt(e,t){const a="DROPIN__COMPANYSWITCHER__COMPANY__CONTEXT",n="DROPIN__COMPANYSWITCHER__GROUP__CONTEXT";if(!sessionStorage.getItem(a))try{const i=await Ne();if(!(i!=null&&i.customerId)||i.customerId!==t)return;sessionStorage.setItem(a,e),sessionStorage.removeItem(n)}catch(i){console.error("Failed to switch company context:",i)}}const Rt=(e,t)=>!e||typeof e!="string"?"":e==="ACTIVE"&&t.statusActive?t.statusActive:e==="INACTIVE"&&t.statusInactive?t.statusInactive:e.charAt(0).toUpperCase()+e.slice(1).toLowerCase(),vt=(e,t)=>{const a=(e==null?void 0:e.trim())||"",n=(t==null?void 0:t.trim())||"";return`${a} ${n}`.trim()},Re=`
...
`,V=e=>{const t=e.has("Magento_Company::view_account"),a=e.has("Magento_Company::view_address"),n=e.has("Magento_Company::contacts"),r=e.has("Magento_Company::payment_information"),i=e.has("Magento_Company::shipping_information"),s=[],c=[];return t&&(s.push("...COMPANY_BASIC_INFO_FRAGMENT"),c.push(qe)),a&&(s.push("legal_address { ...COMPANY_LEGAL_ADDRESS_FRAGMENT }"),c.push(De)),n&&(s.push("company_admin { ...COMPANY_ADMIN_FRAGMENT }"),s.push("sales_representative { ...COMPANY_SALES_REPRESENTATIVE_FRAGMENT }"),c.push(Ve),c.push(xe)),r&&s.push("available_payment_methods { code title }"),i&&s.push("available_shipping_methods { code title }"),{fields:s,usedFragments:c}},He=e=>{const{fields:t,usedFragments:a}=V(e);return t.length===0?`
  ...
  `}
${a.join(`
`)}`},je=e=>{const{fields:t,usedFragments:a}=V(e);return t.length===0?`
  ...
  `}
${a.join(`
`)}`};async function Ft(){return await x().then(async({allowedIds:e,roleResponse:t})=>{var s,c,o;const a=He(e),n=await d(a,{method:"GET",cache:"no-cache"});if((s=n.errors)!=null&&s.length)return _(n.errors);const r=(c=n==null?void 0:n.data)==null?void 0:c.company;return r&&Object.keys(r).some(u=>u!=="__typename")?(n!=null&&n.data&&((o=t==null?void 0:t.data)!=null&&o.customer)&&(n.data.customer=t.data.customer),q(n)):null}).catch(m)}const ze=`
...
`,Dt=async()=>await d(ze,{method:"GET",cache:"no-cache"}).then(e=>{var a;return(a=e.errors)!=null&&a.length?null:Ie(e)}).catch(m),Be=`
...
`,qt=async(e={})=>{const{filter:t,pageSize:a=20,currentPage:n=1}=e,r=t?{custom_reference_number:t.customReferenceNumber,operation_type:t.operationType,updated_by:t.updatedBy}:null;return await d(Be,{method:"GET",cache:"no-cache",variables:{filter:r,pageSize:a,currentPage:n}}).then(i=>{var c;return(c=i.errors)!=null&&c.length?null:Me(i)}).catch(m)};var ke=(e=>(e.ALLOCATION="ALLOCATION",e.UPDATE="UPDATE",e.PURCHASE="PURCHASE",e.REIMBURSEMENT="REIMBURSEMENT",e))(ke||{});const Qe=`
  ...
  ${$}
`;async function xt(){return await d(Qe,{method:"GET",cache:"no-cache"}).then(e=>{var n;if((n=e.errors)!=null&&n.length)return _(e.errors);const t=e.data.customer.company_hierarchy,a=e.data.customer.companies.items;return oe(t,a)}).catch(m)}const We=`
...
`;async function Ht(e){return await d(Xe,{variables:{id:e}}).then(t=>{var n,r,i;if((n=t.errors)!=null&&n.length)return _(t.errors);const a=(i=(r=t==null?void 0:t.data)==null?void 0:r.company)==null?void 0:i.team;return a?ge(a):null}).catch(m)}const Ke=`
...
`;async function jt(e){return await d(Ke,{variables:{id:e}}).then(t=>{var n,r,i;if((n=t.errors)!=null&&n.length)return _(t.errors);const a=(i=(r=t==null?void 0:t.data)==null?void 0:r.company)==null?void 0:i.user;return a?Ce(a):null}).catch(m)}const Je=`
...
`,Bt=async()=>{const e="_company_countries",t=sessionStorage.getItem(e);return t?JSON.parse(t):await d(Ze,{method:"GET"}).then(a=>{var r;if((r=a.errors)!=null&&r.length)return _(a.errors);const n=he(a);return sessionStorage.setItem(e,JSON.stringify(n)),n}).catch(m)},et=`
...
`;async function Kt(e){const t={treeId:e.id,parentTreeId:e.parentId};return await d(nt,{variables:t}).then(a=>{var n,r;return(n=a.errors)!=null&&n.length?_(a.errors):!!((r=a==null?void 0:a.data)!=null&&r.updateCompanyStructure)}).catch(m)}const rt=`
  mutation updateCompanyTeam($input: CompanyTeamUpdateInput!) {
    updateCompanyTeam(input: $input) { __typename team { id name } }
  }
`;async function Jt(e){const t={id:e.id,name:e.name,description:e.description};return await d(rt,{variables:{input:t}}).then(a=>{var n,r,i,s;return(n=a.errors)!=null&&n.length?_(a.errors):!!((s=(i=(r=a==null?void 0:a.data)==null?void 0:r.updateCompanyTeam)==null?void 0:i.team)!=null&&s.id)}).catch(m)}const ot=`
  mutation updateCompanyUser($input: CompanyUserUpdateInput!) {
    updateCompanyUser(input: $input) { __typename user { id } }
  }
`;async function Zt(e){const t={id:e.id,email:e.email,firstname:e.firstName,lastname:e.lastName,job_title:e.jobTitle,telephone:e.telephone,role_id:e.roleId,status:e.status};return await d(ot,{variables:{input:t}}).then(a=>{var n,r,i,s;return(n=a.errors)!=null&&n.length?_(a.errors):!!((s=(i=(r=a==null?void 0:a.data)==null?void 0:r.updateCompanyUser)==null?void 0:i.user)!=null&&s.id)}).catch(m)}const it=`
...
`,ea=async e=>{var r,i,s;const{id:t,status:a}=e;if(!t)throw new Error("User ID is required to update company user status");if(!a||a!=="ACTIVE"&&a!=="INACTIVE")throw new Error("Valid status (ACTIVE or INACTIVE) is required to update company user status");const n=await d(it,{method:"POST",cache:"no-cache",variables:{input:{id:t,status:a}}}).catch(m);return(r=n.errors)!=null&&r.length&&_(n.errors),(s=(i=n.data)==null?void 0:i.updateCompanyUser)!=null&&s.user?{success:!0,user:{id:n.data.updateCompanyUser.user.id,status:n.data.updateCompanyUser.user.status}}:{success:!1}},st=`
...
`,na=async(e={})=>{try{const t=await d(dt,{variables:e,method:"GET",cache:"no-cache"});return ce(t)}catch(t){return m(t)}},ra=async e=>{try{const t=await d(lt,{variables:e,method:"GET",cache:"no-cache"});return de(t)}catch(t){return m(t)}},oa=async()=>{try{const e=await d(mt,{method:"GET",cache:"force-cache"});return le(e)}catch(e){return m(e)}},_t=`
...
`,ia=async e=>{try{const t={input:_e(e)},a=await d(_t,{variables:t,method:"POST"});return me(a)}catch(t){return m(t)}},sa=async e=>{try{const t={input:pe(e)},a=await d(pt,{variables:t,method:"POST"});return ue(a)}catch(t){return m(t)}},ca=async e=>{var t;try{const a=await d(yt,{variables:e,method:"POST"});return(t=a.errors)!=null&&t.length?_(a.errors):a.data.deleteCompanyRole.success}catch(a){return m(a)}},da=async e=>{var t;try{const a=await d(ut,{variables:e,method:"GET",cache:"no-cache"});return(t=a.errors)!=null&&t.length?_(a.errors):a.data.isCompanyRoleNameAvailable.is_role_name_available}catch(a){return m(a)}},la=e=>J(e),ma=(e,t)=>{const a=new Set(t),n=r=>{var s;const i=((s=r.children)==null?void 0:s.map(n).filter(c=>c!==null))||[];return a.has(r.id)||i.length>0?{...r,children:i}:null};return e.map(n).filter(r=>r!==null)};export{ke as CompanyCreditOperationType,Ae as DEFAULT_COUNTRY,W as E,O as STORE_CONFIG_DEFAULTS,vt as a,wt as acceptCompanyInvitation,St as allowCompanyRegistration,Ot as assignChildCompany,ee as b,ma as buildPermissionTree,Rt as c,Pt as checkCompanyCreditEnabled,ne as companyEnabled,Et as config,Ut as createCompany,ia as createCompanyRole,Yt as createCompanyTeam,Gt as createCompanyUser,Mt as d,ca as deleteCompanyRole,$t as deleteCompanyTeam,Lt as deleteCompanyUser,J as f,d as fetchGraphQl,x as fetchUserPermissions,la as flattenPermissionIds,Ft as getCompany,oa as getCompanyAclResources,Dt as getCompanyCredit,qt as getCompanyCreditHistory,xt as getCompanyHierarchy,ra as getCompanyRole,na as getCompanyRoles,Vt as getCompanyStructure,Ht as getCompanyTeam,jt as getCompanyUser,zt as getCompanyUsers,Q as getConfig,Bt as getCountries,Ne as getCustomerCompany,bt as getStoreConfig,U as i,F as initialize,kt as isCompanyAdmin,da as isCompanyRoleNameAvailable,Qt as isCompanyUser,Wt as isCompanyUserEmailAvailable,It as p,k as removeFetchGraphQlHeader,Nt as s,At as setEndpoint,D as setFetchGraphQlHeader,Tt as setFetchGraphQlHeaders,ta as unassignChildCompany,Xt as updateCompany,sa as updateCompanyRole,Kt as updateCompanyStructure,Jt as updateCompanyTeam,Zt as updateCompanyUser,ea as updateCompanyUserStatus,aa as validateCompanyEmail};
