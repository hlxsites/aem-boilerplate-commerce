...
All Rights Reserved. */
import{f as m,h as i}from"./chunks/fetch-error.js";import{g as x,r as O,s as G,a as b,b as I}from"./chunks/fetch-error.js";import{f as P}from"./chunks/fetchUserPermissions.js";import{a as v,i as w}from"./chunks/isCompanyUser.js";import{c as L,g as M}from"./chunks/getCustomerCompany.js";import{D,S as k,c as W,g as Y}from"./chunks/transform-store-config.js";import{c as z,d as j,a as B,g as J,b as K,u as V}from"./chunks/updateCompanyTeam.js";import{c as Z,d as $,g as ee,i as ae,u as re}from"./chunks/updateCompanyUser.js";import{g as oe,u as se}from"./chunks/updateCompany.js";import{g as me,u as pe}from"./chunks/updateCompanyUserStatus.js";import{g as ce,v as le}from"./chunks/validateCompanyEmail.js";import{G as c,t as l}from"./chunks/isCompanyRoleNameAvailable.js";import{c as ye,d as Ce,a as fe,g as de,i as ge,u as he}from"./chunks/isCompanyRoleNameAvailable.js";import{f as u}from"./chunks/company-permissions.js";import"@dropins/tools/fetch-graphql.js";import"@dropins/tools/event-bus.js";const E=async e=>{try{const r=await m(c,{variables:e,method:"GET",cache:"no-cache"});return l(r)}catch(r){return i(r)}},T=e=>u(e),R=(e,r)=>{const n=new Set(r),o=a=>{var t;const s=((t=a.children)==null?void 0:t.map(o).filter(p=>p!==null))||[];return n.has(a.id)||s.length>0?{...a,children:s}:null};return e.map(o).filter(a=>a!==null)},S=async(e={})=>({success:!0,config:e}),y=`
