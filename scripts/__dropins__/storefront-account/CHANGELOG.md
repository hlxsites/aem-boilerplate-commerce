...
## 4.2.0-alpha-20260901085334

### Minor Changes

- d19d0bc: Add `getCompanyAddressBookConfig` for reading the company address book configuration without requesting address data, and export the company address book permission constants as `COMPANY_ADDRESS_PERMISSIONS`
