...
All Rights Reserved. */
import{events as _}from"@dropins/tools/event-bus.js";import{FetchGraphQL as F}from"@dropins/tools/fetch-graphql.js";import{Initializer as $}from"@dropins/tools/lib.js";var N=(e=>(e.NEW="NEW",e.SUBMITTED="SUBMITTED",e.PENDING="PENDING",e.UPDATED="UPDATED",e.OPEN="OPEN",e.ORDERED="ORDERED",e.CLOSED="CLOSED",e.DECLINED="DECLINED",e.EXPIRED="EXPIRED",e.DRAFT="DRAFT",e))(N||{}),g=(e=>(e.ACTIVE="Active",e.IN_REVIEW="In Review",e.INACTIVE="Inactive",e.SUBMITTED="Submitted",e.PENDING="Pending",e.CLOSED="Closed",e.OPEN="Open",e.UPDATED="Updated",e.EDITED="Edited",e.NEW="New",e.DRAFT="Draft",e.DECLINED="Declined",e.CANCELED="Canceled",e.EXPIRED="Expired",e))(g||{}),y=(e=>(e[e.TAX_EXCLUDED=1]="TAX_EXCLUDED",e[e.TAX_INCLUDED=2]="TAX_INCLUDED",e[e.TAX_INCLUDED_AND_EXCLUDED=3]="TAX_INCLUDED_AND_EXCLUDED",e))(y||{});const A={requestQuote:!1,editQuote:!1,deleteQuote:!1,checkoutQuote:!1,viewQuoteTemplates:!1,manageQuoteTemplates:!1,generateQuoteFromTemplate:!1},v={quoteSummaryDisplayTotal:1,quoteSummaryMaxItems:10,quoteDisplaySettings:{zeroTax:!1,subtotal:y.TAX_INCLUDED,price:y.TAX_INCLUDED,shipping:y.TAX_INCLUDED,fullSummary:!1,grandTotal:!0},useConfigurableParentThumbnail:!0,quoteMinimumAmount:null,quoteMinimumAmountMessage:null},C={authenticated:!1,permissions:A,config:v,initialized:!1,quoteDataLoaded:!1,quoteDataInitialized:!1},l=new Proxy(C,{get:(e,a)=>e[a],set:(e,a,t)=>(e[a]=t,!0)});function R(e){if(!e||typeof e!="object")return{requestQuote:!1,editQuote:!1,deleteQuote:!1,checkoutQuote:!1,viewQuoteTemplates:!1,manageQuoteTemplates:!1,generateQuoteFromTemplate:!1};if(e.all===!0)return{requestQuote:!0,editQuote:!0,deleteQuote:!0,checkoutQuote:!0,viewQuoteTemplates:!0,manageQuoteTemplates:!0,generateQuoteFromTemplate:!0};const a=e["Magento_NegotiableQuote::all"]===!0,t=e["Magento_NegotiableQuoteTemplate::all"]===!0,r=a||e["Magento_NegotiableQuote::manage"]===!0;return{requestQuote:r,editQuote:r,deleteQuote:r,checkoutQuote:a||e["Magento_NegotiableQuote::checkout"]===!0,viewQuoteTemplates:t||e["Magento_NegotiableQuoteTemplate::view_template"]===!0,manageQuoteTemplates:t||e["Magento_NegotiableQuoteTemplate::manage"]===!0,generateQuoteFromTemplate:t||e["Magento_NegotiableQuoteTemplate::generate_quote"]===!0}}function b(e){if(l.quoteDataLoaded)return;const a=Q.config.getConfig(),{quoteId:t,quoteTemplateId:r}=a;!e.editQuote||!t&&!r||(l.quoteDataLoaded=!0,t&&ue(t).then(o=>{l.quoteDataInitialized||_.emit("quote-management/quote-data/initialized",{quote:o,permissions:e}),l.quoteDataInitialized=!0}).catch(o=>{l.quoteDataLoaded=!1,_.emit("quote-management/quote-data/error",{error:o})}),r&&Ne(r).catch(o=>{l.quoteDataLoaded=!1,_.emit("quote-management/quote-template-data/error",{error:o})}))}const Q=new $({init:async e=>{const a={};Q.config.setConfig({...a,...e}),await Ee().then(t=>{l.config=t}).catch(t=>{console.error("Failed to fetch store config: ",t),l.config=v}),l.initialized=!0,_.emit("quote-management/initialized",{config:l.config})},listeners:()=>[_.on("authenticated",async e=>{l.authenticated=!!e,e||(l.permissions=A,l.quoteDataLoaded=!1,_.emit("quote-management/permissions",A))},{eager:!0}),_.on("auth/permissions",async e=>{const a=R(e);l.permissions=a,l.quoteDataLoaded=!1,_.emit("quote-management/permissions",l.permissions)},{eager:!0}),_.on("quote-management/permissions",async e=>{l.initialized&&b(e)},{eager:!0}),_.on("quote-management/initialized",async()=>{b(l.permissions)},{eager:!0}),_.on("checkout/updated",async e=>{l.initialized&&(e==null?void 0:e.type)==="quote"&&(l.quoteDataLoaded=!1,b(l.permissions))},{eager:!0})]}),Ye=Q.config,{setEndpoint:Ke,setFetchGraphQlHeader:Je,removeFetchGraphQlHeader:Ze,setFetchGraphQlHeaders:et,fetchGraphQl:p,getConfig:tt}=new F().getMethods(),G=`
...
`,nt=async e=>{var t;if(!l.authenticated)return Promise.reject(new Error("Unauthorized"));const a=Array.isArray(e)?e:[e];try{const r=await p(fe,{variables:{quoteUids:a}}),{errors:o}=r||{};if(o&&o.length){const u=o.map(i=>i==null?void 0:i.message).filter(Boolean).join("; ");throw new Error(u||"Failed to delete negotiable quotes")}const n=(t=r==null?void 0:r.data)==null?void 0:t.deleteNegotiableQuotes;if(!n)throw new Error("No delete result returned");const c={resultStatus:n.result_status,operationResults:(n.operation_results||[]).map(u=>(u==null?void 0:u.__typename)==="NegotiableQuoteUidOperationSuccess"?{__typename:"NegotiableQuoteUidOperationSuccess",quoteUid:u==null?void 0:u.quote_uid}:{__typename:"DeleteNegotiableQuoteOperationFailure",quoteUid:u==null?void 0:u.quote_uid,errors:((u==null?void 0:u.errors)||[]).map(m=>({__typename:m==null?void 0:m.__typename,message:m==null?void 0:m.message,uid:m==null?void 0:m.uid}))})},d=c.operationResults.filter(u=>u.__typename==="NegotiableQuoteUidOperationSuccess").map(u=>u.quoteUid);return d.length>0&&_.emit("quote-management/negotiable-quote-deleted",{deletedQuoteUids:d,resultStatus:c.resultStatus}),c}catch(r){return _.emit("quote-management/negotiable-quote-delete-error",{error:r instanceof Error?r:new Error(String(r)),attemptedQuoteUids:a}),Promise.reject(r)}},Te=`
  ...
  ${I}
`;function Ie(e){const{additionalInput:a,...t}=e,r={city:t.city,company:t.company,country_code:t.countryCode,firstname:t.firstname,lastname:t.lastname,postcode:t.postcode,region:t.region,region_id:t.regionId,save_in_address_book:t.saveInAddressBook,street:t.street,telephone:t.telephone};return{...a||{},...r}}const it=async e=>{const{quoteUid:a,addressId:t,companyAddressId:r,addressData:o}=e;if(!a)throw new Error("Quote UID is required");const n=[t!=null,r!=null,!!o].filter(Boolean).length;if(n===0)throw new Error("One of addressId, companyAddressId or addressData must be provided");if(n>1)throw new Error("Provide only one of addressId, companyAddressId or addressData");const c=o?Ie(o):null;return p(Te,{variables:{quoteUid:a,addressId:t??null,companyAddressId:r??null,addressData:c}}).then(d=>{var s,m;const{errors:u}=d;if(u){const E=u.map(w=>w.message).join("; ");throw new Error(`Failed to set shipping address: ${E}`)}const i=h((m=(s=d.data)==null?void 0:s.setNegotiableQuoteShippingAddress)==null?void 0:m.quote);if(!i)throw new Error("Failed to transform quote data: Invalid response structure");return _.emit("quote-management/shipping-address-set",{quote:i,input:{quoteUid:a,addressId:t,companyAddressId:r,addressData:o}}),i})},he=`
...
`,ft=async e=>{var a;if(!e.templateId)throw new Error("Template ID is required");if(!l.authenticated)throw new Error("Unauthorized");try{const t=await p(Le,{variables:{templateId:e.templateId}});if(!((a=t==null?void 0:t.data)!=null&&a.openNegotiableQuoteTemplate))throw new Error("No quote template data received");const r=f(t.data.openNegotiableQuoteTemplate);if(!r)throw new Error("Failed to transform quote template data");return _.emit("quote-management/quote-template-data",{quoteTemplate:r,permissions:l.permissions}),r}catch(t){return Promise.reject(t)}},Fe=`
  ...
  ${T}
`,Tt=async e=>{var t;if(!e.templateId)throw new Error("Template ID is required");if(!e.shippingAddress)throw new Error("Shipping address is required");if(!l.authenticated)throw new Error("Unauthorized");const a=[!!e.shippingAddress.address,e.shippingAddress.customerAddressUid!=null,e.shippingAddress.companyAddressId!=null].filter(Boolean).length;if(a===0)throw new Error("One of address, customerAddressUid or companyAddressId must be provided");if(a>1)throw new Error("Provide only one of address, customerAddressUid or companyAddressId");try{const r=await p(Fe,{variables:{templateId:e.templateId,shippingAddress:{address:e.shippingAddress.address?{city:e.shippingAddress.address.city,company:e.shippingAddress.address.company,country_code:e.shippingAddress.address.countryCode,fax:e.shippingAddress.address.fax,firstname:e.shippingAddress.address.firstname,lastname:e.shippingAddress.address.lastname,middlename:e.shippingAddress.address.middlename,postcode:e.shippingAddress.address.postcode,prefix:e.shippingAddress.address.prefix,region:e.shippingAddress.address.region,region_id:e.shippingAddress.address.regionId,save_in_address_book:e.shippingAddress.address.saveInAddressBook,street:e.shippingAddress.address.street,suffix:e.shippingAddress.address.suffix,telephone:e.shippingAddress.address.telephone,vat_id:e.shippingAddress.address.vatId}:void 0,customer_address_uid:e.shippingAddress.customerAddressUid,company_address_id:e.shippingAddress.companyAddressId,customer_notes:e.shippingAddress.customerNotes}}});if(!((t=r==null?void 0:r.data)!=null&&t.setNegotiableQuoteTemplateShippingAddress))throw new Error("No quote template data received");const o=f(r.data.setNegotiableQuoteTemplateShippingAddress);if(!o)throw new Error("Failed to transform quote template data");return _.emit("quote-management/quote-template-data",{quoteTemplate:o,permissions:l.permissions}),o}catch(r){return Promise.reject(r)}},$e=`
