    ...
    return (
      (() => {
        ...
        const l = n.n(d)(),
          ...
          S = "STYLE",
          k = "SCRIPT",
          D = ({ src: e, currentDocument: t = document }) =>
            new Promise((n, o) => {
        ...
        const ie = n.n(re)(),
          ...
          le = (e) => {
            ...
            return `${t}-${n}-${o}T${r}:${i}:${a}.${s}${c > 0 ? "-" : "+"}${de(
              Math.floor(Math.abs(c) / 60),
              2,
              "0"
            )}:${de(Math.abs(c) % 60, 2, "0")}`;
          };
        var me = n(426);
        const pe = n.n(me)(),
          fe = (e, t, n = {}) => {
          ...
          ye = (e, t) => (ve(P(e), e, t, "a function"), e),
          we = (e, t) => (n, o) => (
          ...
          De = (e, t) => (ve(te(e), e, t, "a string"), e),
          Pe = (e) => e;
        (Pe.default = function (e) {
          return fe(
            this,
            (
              (e) => (t) =>
        ...
        const gt = ft,
          ...
          At = () => {
            const e = {},
              t = Rt({ content: e, addIdentity: Dt(e), hasIdentity: Ot(e) });
            return (
              (t.addEvent = (t) => {
          ...
          jt = (e) => {
            ...
            return Rt({ content: t, addIdentity: Dt(t), hasIdentity: Ot(t) });
          },
          Nt = /^([^?#]*)(\??[^#]*)(#?.*)$/,
          Lt = ({
            config: e,
        ...
        const Do = ko,
          Po = ({ config: e, componentRegistry: t }) => {
        ...
        const Ao = [mt, gt, Mt, Bt, uo, vo, Eo, Do, To, Oo],
          qo = (e) => u({}, e),
          jo =
        ...
        function Rr(e) {
          return (
            ...
            (Array.isArray(e[1]) ? e[1].every(Pr) : Pr(e[1]))
          );
        }
        function Or(e) {
          return Tr(e) || Rr(e);
        ...
        function ti(e, t, n, o, r, i, a, s, c, u, d, l, m, p, f, g, v) {
          var h,
            ...
            k = !E && S && ("post" === o || I),
            D = k ? r : "/i",
            P = "snowplowOutQueue_".concat(e, "_").concat(k ? "post2" : "get");
          if (
            (I && (m = {}),
            (i =
              (n &&
              ...
              if (S) {
                ...
                var s = setTimeout(function () {
                  ...
                  c = function (e) {
                    ...
                    n && $r(P, JSON.stringify(b.slice(0, u)));
                  },
                  m = function (e) {
                    c(e), j();
                  };
          ...
          return {
            enqueueRequest: function (e, t) {
              ...
              var m = !1;
              n && (m = $r(P, JSON.stringify(b.slice(0, u)))),
                w || (m && !(b.length >= i)) || j();
            },
            ...
            s = (function (e, t, n, o, r, i) {
              ...
              var F,
                ...
                Ae = ti(
                  ...
                  null !== (D = i.maxLocalStorageQueueSize) && void 0 !== D
                    ? D
                    : 1e3,
                  null !== (P = i.connectionTimeout) && void 0 !== P ? P : 5e3,
                  De,
        ...
        const wi =
          ...
          Pi = "iglu:com.adobe.magento.entity/search-input/jsonschema/2-0-0",
          Ti =
          ...
          Gi = () => ({ schema: Ei, data: { magentoJsVersion: "1.8.0" } }),
          Yi = (e) => {
            const {
                pageContext: t,
                orderContext: n,
          ...
          return (
            ...
            (r = function* () {
              ...
              r && 0 !== Object.keys(r).length && (i = r),
                ...
                (i.commerce.order.discountAmount =
                ...
                ((e, t) => {
                  ...
                  if (e)
                    try {
                      ...
                      console.error(
                        `error subscribing to Commerce events: ${JSON.stringify(
                          e
                        )}`
                      );
                    }
                  if (t)
                    try {
                      n.subscribe.addToCart(sa),
                        ...
                        n.subscribe.searchResponseReceived(Da),
                        n.subscribe.shoppingCartView(Na),
                        n.subscribe.signIn(sr),
                        n.subscribe.signOut(cr);
                    } catch (e) {
                      console.error(
                        `error subscribing to Experience events: ${JSON.stringify(
                          e
                        )}`
                      );
                    }
