...
// Other files to copy
[
  { from: '@adobe/magento-storefront-event-collector/storefront-payment-services/index.js', to: 'commerce-events-collector.js' },
  { from: '@adobe/magento-storefront-events-sdk/storefront-payment-services/index.js', to: 'commerce-events-sdk.js' },
  { from: '@adobe/adobe-client-data-layer/storefront-payment-services/adobe-client-data-layer.min.js', to: 'acdl/adobe-client-data-layer.min.js' },
  { from: '@adobe/adobe-client-data-layer/storefront-payment-services/adobe-client-data-layer.min.js.map', to: 'acdl/adobe-client-data-layer.min.js.map' },
].forEach((file) => {
