...
- **Order Search**: Full view searches all order history and switches the date filter to "View all"
...
4. **Order Search**: Submitting a search switches the date filter to "View all"
